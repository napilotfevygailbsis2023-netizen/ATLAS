...
HIGHLIGHTS = [
    {"name":"Intramuros",      "city":"Manila",       "color":"#0038A8","cat":"Historical","icon":"<i class='fa-solid fa-landmark'></i>"},
    {"name":"Paoay Church",    "city":"Ilocos Norte", "color":"#C8930A","cat":"Heritage",  "icon":"<i class='fa-solid fa-place-of-worship'></i>"},
    {"name":"Taal Volcano",    "city":"Batangas",     "color":"#065F46","cat":"Nature",    "icon":"<i class='fa-solid fa-mountain'></i>"},
    {"name":"Calle Crisologo", "city":"Vigan",        "color":"#CE1126","cat":"Heritage",  "icon":"<i class='fa-solid fa-house'></i>"},
]
OFFERS = [
    {"title":"Book a Tour Guide",  "desc":"Get a certified local guide for your Luzon trip",     "color":"#0038A8","href":"/guides.py",  "icon":"<i class='fa-solid fa-user-tie'></i>"},
    {"title":"Check Live Weather", "desc":"Plan safely with real-time forecasts for each city",  "color":"#CE1126","href":"/weather.py", "icon":"<i class='fa-solid fa-cloud-sun'></i>"},
    {"title":"Search Flights",     "desc":"Find the best domestic fares to Luzon destinations",  "color":"#C8930A","href":"/flights.py", "icon":"<i class='fa-solid fa-plane'></i>"},
]
...
def render(user=None):
    ...
    <div class="offer-card" style="background:linear-gradient(135deg,{o['color']},{o['color']}CC)"
      ...
      <div style="font-size:28px;margin-bottom:10px">{o['icon']}</div>
    ...
    <div class="hero">
      ...
      <div class="hero-dots">
        ...
        <div class="hero-dot" style="background:#1E3A5F"></div>
      ...
      <div class="search-box">
        <span style="padding:0 10px 0 16px;display:flex;align-items:center;font-size:18px"><i class='fa-solid fa-magnifying-glass'></i></span>
    ...
    <div class="page-wrap">
      ...
      <!-- CAROUSEL -->
      <div style="position:relative;margin-bottom:28px" id="carousel-wrap">
        ...
        <button onclick="carouselMove(-1)" style="position:absolute;top:45%;left:-18px;transform:translateY(-50%);background:rgba(0,0,0,.5);color:#fff;border:none;border-radius:50%;width:38px;height:38px;font-size:20px;cursor:pointer;z-index:10"><i class='fa-solid fa-chevron-left'></i></button>
        <button onclick="carouselMove(1)"  style="position:absolute;top:45%;right:-18px;transform:translateY(-50%);background:rgba(0,0,0,.5);color:#fff;border:none;border-radius:50%;width:38px;height:38px;font-size:20px;cursor:pointer;z-index:10"><i class='fa-solid fa-chevron-right'></i></button>
