...
.back-link{{position:fixed;top:20px;left:20px;display:flex;align-items:center;gap:6px;background:rgba(255,255,255,.12);backdrop-filter:blur(8px);border:1px solid rgba(255,255,255,.25);color:#fff;text-decoration:none;padding:8px 16px;border-radius:20px;font-size:13px;font-weight:600;z-index:999}}
...
<div class="split-left">
  ...
  <div style="position:relative;z-index:2;text-align:center;color:#fff">
    <div style="font-size:72px;margin-bottom:20px"><i class="fa-solid fa-gear"></i></div>
    <div style="font-size:28px;font-weight:800;line-height:1.2;margin-bottom:14px">ATLAS<br/>Admin Panel</div>
    <div style="font-size:15px;opacity:.8;line-height:1.8;margin-bottom:28px;max-width:300px">Manage tourists, attractions, restaurants, tour guides and transportation routes.</div>
    <div style="display:flex;flex-direction:column;gap:10px;font-size:14px;opacity:.9;text-align:left">
      <div style="display:flex;align-items:center;gap:12px;background:rgba(255,255,255,.08);padding:12px 16px;border-radius:12px"><span style="font-size:20px"><i class="fa-solid fa-user"></i></span> Manage tourist accounts</div>
      <div style="display:flex;align-items:center;gap:12px;background:rgba(255,255,255,.08);padding:12px 16px;border-radius:12px"><span style="font-size:20px"><i class="fa-solid fa-landmark"></i></span> Add attractions & restaurants</div>
      <div style="display:flex;align-items:center;gap:12px;background:rgba(255,255,255,.08);padding:12px 16px;border-radius:12px"><span style="font-size:20px"><i class="fa-solid fa-user-tie"></i></span> Manage tour guides</div>
      <div style="display:flex;align-items:center;gap:12px;background:rgba(255,255,255,.08);padding:12px 16px;border-radius:12px"><span style="font-size:20px"><i class="fa-solid fa-bus"></i></span> Transportation routes</div>
    </div>
  </div>
</div>
<div class="split-right">
  <div style="margin-bottom:32px">
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:6px">
      <div style="width:32px;height:32px;background:linear-gradient(135deg,#0F172A,#0038A8);border-radius:8px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:15px">A</div>
      <span style="font-weight:800;font-size:18px;color:#1F2937">ATLAS Admin</span>
    </div>
    <div style="font-size:13px;color:#475569">Restricted access — authorized personnel only</div>
  </div>
  ...
  <div style="font-size:14px;color:#475569;margin-bottom:28px">Sign in to the ATLAS admin dashboard</div>
  {err}{suc}
  <form method="post" action="/admin/login">
    ...
    <button class="submit-btn" type="submit">Sign In <i class="fa-solid fa-arrow-right"></i></button>
  </form>
</div>
</body>
</html>"""
