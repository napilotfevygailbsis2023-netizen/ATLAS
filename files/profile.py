...
def render(user=None, msg="", err=""):
    ...
    msg_html = f'<div style="background:#D1FAE5;color:#065F46;padding:12px 16px;border-radius:8px;margin-bottom:16px;font-weight:600"><i class="fa-solid fa-check"></i> {msg}</div>' if msg else ""
    err_html  = f'<div style="background:#FEE2E2;color:#DC2626;padding:12px 16px;border-radius:8px;margin-bottom:16px;font-weight:600"><i class="fa-solid fa-triangle-exclamation"></i> {err}</div>' if err else ""
    ...
    <div class="page-wrap" style="max-width:700px;margin:0 auto">
      ...
      <div class="card" style="margin-bottom:20px">
        <div class="card-hdr" style="background:#0038A8"><span><i class="fa-solid fa-user"></i> Account Information</span></div>
        <div class="card-body">
          <div style="display:flex;align-items:center;gap:20px;margin-bottom:24px;padding-bottom:20px;border-bottom:1px solid #F3F4F6">
            <div style="width:80px;height:80px;border-radius:50%;background:linear-gradient(135deg,#0038A8,#CE1126);display:flex;align-items:center;justify-content:center;font-size:32px;font-weight:800;color:#fff;flex-shrink:0">{initials}</div>
            <div>
              <div style="font-size:22px;font-weight:800;color:#1F2937">{fname} {lname}</div>
              <div style="font-size:14px;color:#475569;margin-top:4px"><i class="fa-regular fa-envelope"></i> {email}</div>
              <div style="margin-top:8px"><span style="background:#DBEAFE;color:#1D4ED8;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600"><i class="fa-solid fa-circle-check"></i> Tourist Account</span></div>
            </div>
          </div>
      ...
      <!-- Change Password -->
      <div class="card" style="margin-bottom:20px">
        <div class="card-hdr" style="background:#1E3A5F"><span><i class="fa-solid fa-lock"></i> Change Password</span></div>
        <div class="card-body">
          <form method="post" action="/profile/update">
      ...
      <!-- Quick Links -->
      <div class="card">
        <div class="card-hdr" style="background:#1E3A5F"><span><i class="fa-solid fa-link"></i> Quick Links</span></div>
        <div class="card-body">
          <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:12px">
            <a href="/itinerary.py" style="text-decoration:none">
              <div style="background:#EFF6FF;border-radius:10px;padding:14px;text-align:center;border:1px solid #DBEAFE">
                <div style="font-size:28px;margin-bottom:6px"><i class="fa-regular fa-calendar"></i></div>
            ...
            <a href="/attractions.py" style="text-decoration:none">
              <div style="background:#F0FDF4;border-radius:10px;padding:14px;text-align:center;border:1px solid #BBF7D0">
                <div style="font-size:28px;margin-bottom:6px"><i class="fa-solid fa-landmark"></i></div>
            ...
            <a href="/restaurants.py" style="text-decoration:none">
              <div style="background:#FFF7ED;border-radius:10px;padding:14px;text-align:center;border:1px solid #FED7AA">
                <div style="font-size:28px;margin-bottom:6px"><i class="fa-solid fa-utensils"></i></div>
            ...
            <a href="/guides.py" style="text-decoration:none">
              <div style="background:#FAF5FF;border-radius:10px;padding:14px;text-align:center;border:1px solid #E9D5FF">
                <div style="font-size:28px;margin-bottom:6px"><i class="fa-solid fa-user-tie"></i></div>
                <div style="font-size:13px;font-weight:700;color:#0038A8">Tour Guides</div>
              </div>
            </a>
          </div>
        </div>
