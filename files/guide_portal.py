...
.tab{{flex:1;padding:10px;text-align:center;border-radius:8px;font-size:14px;font-weight:600;text-decoration:none;color:#475569}}
...
.field input:focus{{border-color:#0038A8;background:#fff;box-shadow:0 0 0 3px rgba(107,33,168,.08)}}
...
<div class="split-left">
  ...
  <div style="position:relative;z-index:2;text-align:center;color:#fff">
    <div style="font-size:72px;margin-bottom:20px"><i class=&#34;fa-solid fa-user-tie&#34;></i></div>
    <div style="font-size:28px;font-weight:800;line-height:1.2;margin-bottom:14px">ATLAS<br/>Guide Portal</div>
    ...
    <div style="display:flex;flex-direction:column;gap:10px;font-size:14px;opacity:.9;text-align:left">
      <div style="display:flex;align-items:center;gap:10px;background:rgba(255,255,255,.1);padding:11px 16px;border-radius:12px"><span><i class=&#34;fa-regular fa-file&#34;></i></span> Create & manage tour packages</div>
      <div style="display:flex;align-items:center;gap:10px;background:rgba(255,255,255,.1);padding:11px 16px;border-radius:12px"><span><i class=&#34;fa-regular fa-calendar&#34;></i></span> Accept or reject bookings</div>
      <div style="display:flex;align-items:center;gap:10px;background:rgba(255,255,255,.1);padding:11px 16px;border-radius:12px"><span><i class=&#34;fa-regular fa-clock&#34;></i></span> Set your weekly availability</div>
      <div style="display:flex;align-items:center;gap:10px;background:rgba(255,255,255,.1);padding:11px 16px;border-radius:12px"><span><i class=&#34;fa-solid fa-star&#34;></i></span> View ratings & feedback</div>
    </div>
  </div>
</div>
<div class="split-right">
  <div style="margin-bottom:28px">
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:6px">
      <div style="width:32px;height:32px;background:linear-gradient(135deg,#6B21A8,#4C1D95);border-radius:8px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:15px">G</div>
      <span style="font-weight:800;font-size:18px;color:#1F2937">Guide Portal</span>
    </div>
    <div style="font-size:13px;color:#475569">ATLAS Tour Guide Management</div>
  </div>
  <div class="tab-row">
  ...
  <div style="font-size:14px;color:#475569;margin-bottom:24px">Sign in to your guide account</div>
  {err}{suc}
...
.field input:focus,.field select:focus{{border-color:#0038A8;background:#fff;box-shadow:0 0 0 3px rgba(107,33,168,.08)}}
.submit-btn{{width:100%;padding:14px;background:linear-gradient(135deg,#6B21A8,#4C1D95);color:#fff;border:none;border-radius:12px;font-size:15px;font-weight:700;cursor:pointer;margin-top:4px}}
.back-link{{position:fixed;top:20px;left:20px;display:flex;align-items:center;gap:6px;background:rgba(255,255,255,.15);backdrop-filter:blur(8px);border:1px solid rgba(255,255,255,.3);color:#fff;text-decoration:none;padding:8px 16px;border-radius:20px;font-size:13px;font-weight:600;z-index:999}}
@media(max-width:700px){{.split-left{{display:none}}.split-right{{width:100%}}}}
</style>
...
<div class="split-left">
  ...
  <div style="position:relative;z-index:2;text-align:center;color:#fff">
    ...
    <div style="font-size:28px;font-weight:800;line-height:1.2;margin-bottom:14px">Join ATLAS<br/>as a Guide!</div>
    ...
    <div style="display:flex;flex-direction:column;gap:12px;font-size:14px;opacity:.9;text-align:left">
      <div style="display:flex;align-items:center;gap:12px;background:rgba(255,255,255,.1);padding:12px 16px;border-radius:12px"><span style="font-size:22px"><i class=&#34;fa-solid fa-money-bill-wave&#34;></i></span><div><div style="font-weight:700">Earn Income</div><div style="font-size:12px;opacity:.8">Set your own rates and packages</div></div></div>
      <div style="display:flex;align-items:center;gap:12px;background:rgba(255,255,255,.1);padding:12px 16px;border-radius:12px"><span style="font-size:22px"><i class=&#34;fa-solid fa-users&#34;></i></span><div><div style="font-weight:700">Meet Tourists</div><div style="font-size:12px;opacity:.8">Connect with travelers from everywhere</div></div></div>
      <div style="display:flex;align-items:center;gap:12px;background:rgba(255,255,255,.1);padding:12px 16px;border-radius:12px"><span style="font-size:22px"><i class=&#34;fa-solid fa-star&#34;></i></span><div><div style="font-weight:700">Build Your Reputation</div><div style="font-size:12px;opacity:.8">Collect ratings and grow your business</div></div></div>
    </div>
  </div>
</div>
<div class="split-right">
  ...
  <div style="font-size:14px;color:#475569;margin-bottom:22px">Join our network of verified local guides</div>
  {err}
  ...
  <div style="text-align:center;margin-top:20px;font-size:13px;color:#475569">
...
def render_dashboard(guide, msg="", err=""):
    ...
    alert = ""
    if msg: alert = f'<div style="background:#D1FAE5;border:1px solid #A7F3D0;border-radius:8px;padding:12px 16px;color:#065F46;font-size:13px;margin-bottom:16px;display:flex;align-items:center;gap:8px"><i class=&#34;fa-solid fa-check&#34;></i> {msg}</div>'
    if err: alert = f'<div style="background:#FEE2E2;border:1px solid #FECACA;border-radius:10px;padding:12px 16px;color:#DC2626;font-size:13px;margin-bottom:20px;display:flex;align-items:center;gap:8px"><i class=&#34;fa-solid fa-triangle-exclamation&#34;></i> {err}</div>'

    # Stat cards
    stats = f"""
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin-bottom:24px">
      <div class="g-stat" style="background:linear-gradient(135deg,#6B21A8,#7C3AED)"><div style="font-size:32px;font-weight:800">{len(packages)}</div><div style="font-size:12px;opacity:.85;margin-top:4px">Packages</div></div>
      <div class="g-stat" style="background:linear-gradient(135deg,#D97706,#F59E0B)"><div style="font-size:32px;font-weight:800">{len(pending)}</div><div style="font-size:12px;opacity:.85;margin-top:4px">Pending</div></div>
      <div class="g-stat" style="background:linear-gradient(135deg,#059669,#10B981)"><div style="font-size:32px;font-weight:800">{len(upcoming)}</div><div style="font-size:12px;opacity:.85;margin-top:4px">Upcoming</div></div>
      <div class="g-stat" style="background:linear-gradient(135deg,#DC2626,#EF4444)"><div style="font-size:32px;font-weight:800">{avg_rating}<i class=&#34;fa-solid fa-star&#34;></i></div><div style="font-size:12px;opacity:.85;margin-top:4px">Avg Rating</div></div>
    </div>"""
    ...
    if pending:
        ...
        <div style="border:1px solid #FDE68A;border-radius:10px;padding:14px 16px;background:#FFFBEB;margin-bottom:10px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px">
          <div>
            ...
            <div style="font-size:12px;color:#475569;margin-top:3px"><i class=&#34;fa-regular fa-calendar&#34;></i> {b["tour_date"]} &bull; {b["pax"]} pax &bull; {b["package_title"] or "Custom Tour"}</div>
            {"" if not b["notes"] else f'<div style="font-size:12px;color:#92400E;margin-top:4px;font-style:italic">"{b["notes"]}"</div>'}
          </div>
          <div style="display:flex;gap:8px">
            <form method="post" action="/guide/dashboard?section=dashboard"><input type="hidden" name="action" value="accept_booking"/><input type="hidden" name="booking_id" value="{b["id"]}"/><button class="g-btn" style="background:#059669;color:#fff;padding:8px 16px;font-size:13px"><i class=&#34;fa-solid fa-check&#34;></i> Accept</button></form>
            <form method="post" action="/guide/dashboard?section=dashboard"><input type="hidden" name="action" value="reject_booking"/><input type="hidden" name="booking_id" value="{b["id"]}"/><button class="g-btn" style="background:#DC2626;color:#fff;padding:8px 16px;font-size:13px"><i class=&#34;fa-solid fa-xmark&#34;></i> Reject</button></form>
          </div>
        </div>""" for b in pending)
        pending_html = f'<div class="g-card"><div class="g-card-hdr" style="background:#1E3A5F"><i class=&#34;fa-solid fa-triangle-exclamation&#34;></i> Pending Booking Requests ({len(pending)})</div><div class="g-card-body">{rows}</div></div>'

    # Upcoming bookings table
    upcoming_html = ""
    if upcoming:
        rows = "".join(f'<tr style="border-bottom:1px solid #F3F4F6"><td style="padding:11px 14px;font-weight:600">{b["tourist_name"]}</td><td style="padding:11px 14px;color:#475569">{b["tour_date"]}</td><td style="padding:11px 14px;color:#475569">{b["package_title"] or "Custom"}</td><td style="padding:11px 14px;color:#475569">{b["pax"]} pax</td></tr>' for b in upcoming[:6])
        upcoming_html = f'<div class="g-card"><div class="g-card-hdr" style="background:#0038A8"><i class=&#34;fa-regular fa-calendar&#34;></i> Upcoming Bookings</div><div class="g-card-body" style="padding:0"><table style="width:100%;border-collapse:collapse"><thead><tr style="background:#F8FAFC"><th style="padding:11px 14px;text-align:left;font-size:12px;color:#475569;font-weight:600">Tourist</th><th style="padding:11px 14px;text-align:left;font-size:12px;color:#475569;font-weight:600">Date</th><th style="padding:11px 14px;text-align:left;font-size:12px;color:#475569;font-weight:600">Package</th><th style="padding:11px 14px;text-align:left;font-size:12px;color:#475569;font-weight:600">Pax</th></tr></thead><tbody>{rows}</tbody></table></div></div>'

    body = f"""
    <div style="margin-bottom:24px">
      <div style="font-size:22px;font-weight:800;color:#0F172A">Dashboard</div>
      <div style="font-size:14px;color:#475569">Welcome back, {guide["fname"]}! <i class=&#34;fa-regular fa-hand&#34;></i></div>
    </div>
    {alert}{stats}{pending_html}{upcoming_html}
    {"" if upcoming_html or pending_html else '<div class="g-card"><div class="g-card-body" style="text-align:center;padding:40px;color:#94A3B8"><div style="font-size:48px;margin-bottom:12px"><i class=&#34;fa-regular fa-calendar&#34;></i></div><div style="font-weight:700;font-size:16px">No bookings yet</div><div style="font-size:13px;margin-top:6px">Add packages to start receiving bookings!</div></div></div>'}"""
...
def render_packages(guide, msg="", err=""):
    ...
    alert = ""
    if msg: alert = f'<div style="background:#D1FAE5;border:1px solid #A7F3D0;border-radius:8px;padding:12px 16px;color:#065F46;font-size:13px;margin-bottom:16px"><i class=&#34;fa-solid fa-check&#34;></i> {msg}</div>'
    if err: alert = f'<div style="background:#FEE2E2;border:1px solid #FECACA;border-radius:10px;padding:12px 16px;color:#DC2626;font-size:13px;margin-bottom:20px"><i class=&#34;fa-solid fa-triangle-exclamation&#34;></i> {err}</div>'
        ...
        <div style="border:1px solid #E2E8F0;border-radius:12px;padding:18px;background:#fff;margin-bottom:14px">
          <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:12px">
            <div style="flex:1">
              ...
              <div style="font-size:12px;color:#475569;margin-top:3px"><i class=&#34;fa-solid fa-location-dot&#34;></i> {p["city"]} &bull; <i class=&#34;fa-regular fa-clock&#34;></i> {p["duration"]}</div>
            ...
            <div style="text-align:right">
              <div style="font-size:22px;font-weight:800;color:#0038A8;white-space:nowrap">{p["price"]}</div>
              <form method="post" action="/guide/packages" style="margin-top:8px">
                <input type="hidden" name="action" value="delete_package"/>
                <input type="hidden" name="pkg_id" value="{p["id"]}"/>
                <button class="g-btn" style="background:#FEE2E2;color:#DC2626;padding:6px 12px;font-size:12px" onclick="return confirm('Delete this package?')"><i class=&#34;fa-regular fa-trash-can&#34;></i> Delete</button>
              </form>
            </div>
          </div>
        </div>"""
    ...
    body = f"""
    <div style="margin-bottom:24px">
      <div style="font-size:22px;font-weight:800;color:#0F172A">My Packages</div>
      <div style="font-size:14px;color:#475569">Create and manage your tour packages</div>
    </div>
    {alert}
    <div class="g-card">
      <div class="g-card-hdr" style="background:#1E3A5F"><i class=&#34;fa-solid fa-plus&#34;></i> Add New Package</div>
      <div class="g-card-body">
        <form method="post" action="/guide/packages" style="display:flex;flex-direction:column;gap:14px">
          ...
          <div><button class="g-btn" type="submit" style="background:#1E3A5F;color:#fff;padding:11px 24px">Add Package</button></div>
        </form>
      </div>
    </div>
    ...
    {pkg_cards or '<div class="g-card"><div class="g-card-body" style="text-align:center;padding:40px;color:#94A3B8"><div style="font-size:48px;margin-bottom:12px"><i class=&#34;fa-regular fa-file&#34;></i></div><div style="font-weight:700">No packages yet</div></div></div>'}"""
...
def render_bookings(guide, filter_status="all", msg="", err=""):
    ...
    for b in shown:
        ...
        if b["status"] == "pending":
            ...
            <div style="display:flex;gap:8px;margin-top:12px;flex-wrap:wrap">
              <form method="post" action="/guide/bookings?filter={filter_status}"><input type="hidden" name="action" value="accept_booking"/><input type="hidden" name="booking_id" value="{b["id"]}"/><button class="g-btn" style="background:#059669;color:#fff;padding:8px 16px;font-size:13px"><i class=&#34;fa-solid fa-check&#34;></i> Accept</button></form>
              <form method="post" action="/guide/bookings?filter={filter_status}"><input type="hidden" name="action" value="reject_booking"/><input type="hidden" name="booking_id" value="{b["id"]}"/><button class="g-btn" style="background:#DC2626;color:#fff;padding:8px 16px;font-size:13px"><i class=&#34;fa-solid fa-xmark&#34;></i> Reject</button></form>
            </div>"""
          ...
          <div style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:10px">
            <div>
              ...
              <div style="font-size:12px;color:#475569;margin-top:4px">
                <i class=&#34;fa-solid fa-phone&#34;></i> {b.get("tourist_phone","N/A")} &bull; <i class=&#34;fa-regular fa-calendar&#34;></i> {b["tour_date"]} &bull; <i class=&#34;fa-solid fa-users&#34;></i> {b["pax"]} pax
              </div>
              <div style="font-size:13px;color:#4B5563;margin-top:4px">Package: <strong>{b["package_title"] or "Custom Tour"}</strong></div>
              {"" if not b["notes"] else f'<div style="font-size:12px;color:#475569;margin-top:4px;font-style:italic;background:rgba(0,0,0,.03);padding:6px 10px;border-radius:6px">"{b["notes"]}"</div>'}
              {"" if not b["guide_notes"] else f'<div style="font-size:12px;color:#2563EB;margin-top:4px"><i class=&#34;fa-solid fa-note-sticky&#34;></i> {b["guide_notes"]}</div>'}
            </div>
    ...
    body = f"""
    <div style="margin-bottom:24px">
      <div style="font-size:22px;font-weight:800;color:#0F172A">Bookings</div>
      <div style="font-size:14px;color:#475569">Manage all your tour bookings</div>
    </div>
    {alert}
    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:20px">{tabs}</div>
    {cards or '<div class="g-card"><div class="g-card-body" style="text-align:center;padding:40px;color:#94A3B8"><div style="font-size:48px;margin-bottom:12px"><i class=&#34;fa-regular fa-calendar&#34;></i></div><div style="font-weight:700">No bookings found</div></div></div>'}"""
...
def render_availability(guide, msg="", err=""):
    ...
    body = f"""
    <div style="margin-bottom:24px">
      <div style="font-size:22px;font-weight:800;color:#0F172A">Availability</div>
      <div style="font-size:14px;color:#475569">Set the days you are available for tours</div>
    </div>
    {alert}
    <div class="g-card" style="max-width:600px">
      <div class="g-card-hdr" style="background:#1E3A5F"><i class=&#34;fa-regular fa-clock&#34;></i> Weekly Schedule</div>
      <div class="g-card-body">
        <form method="post" action="/guide/availability" style="display:flex;flex-direction:column;gap:16px">
          <input type="hidden" name="action" value="update_availability"/>
          <div style="font-size:13px;color:#475569;margin-bottom:8px">Select the days you are available:</div>
          ...
          <div><button class="g-btn" type="submit" style="background:#1E3A5F;color:#fff;padding:12px 28px">Save Availability</button></div>
        </form>
      </div>
    </div>"""
...
def render_ratings(guide):
    ...
    for s in range(5, 0, -1):
        ...
        stars_bar += f'<div style="display:flex;align-items:center;gap:12px;margin-bottom:8px"><span style="font-size:13px;min-width:25px;color:#475569">{s}<i class=&#34;fa-solid fa-star&#34;></i></span><div style="flex:1;height:12px;background:#F3F4F6;border-radius:6px;overflow:hidden"><div style="height:100%;width:{pct}%;background:#F59E0B;border-radius:6px"></div></div><span style="font-size:12px;color:#475569;min-width:30px">{cnt}</span></div>'
    ...
    <div style="border:1px solid #E2E8F0;border-radius:12px;padding:16px;margin-bottom:12px;background:#fff">
      <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:8px">
        ...
        <div style="color:#D97706;font-size:16px">{"<i class=&#34;fa-solid fa-star&#34;></i>"*r["rating"]}{"<i class=&#34;fa-regular fa-star&#34;></i>"*(5-r["rating"])}</div>
      </div>
      ...
      <div style="font-size:11px;color:#94A3B8;margin-top:8px">{r["created"][:10]}</div>
    </div>""" for r in ratings) or '<div style="text-align:center;padding:40px;color:#94A3B8"><div style="font-size:48px;margin-bottom:12px"><i class=&#34;fa-solid fa-star&#34;></i></div><div style="font-weight:700">No reviews yet</div></div>'

    body = f"""
    <div style="margin-bottom:24px">
      <div style="font-size:22px;font-weight:800;color:#0F172A">Ratings & Feedback</div>
      <div style="font-size:14px;color:#475569">See what tourists say about your tours</div>
    </div>
    <div style="display:grid;grid-template-columns:300px 1fr;gap:20px;margin-bottom:24px">
      <div class="g-card">
        <div class="g-card-hdr" style="background:#1E3A5F"><i class=&#34;fa-solid fa-star&#34;></i> Overall Rating</div>
        <div class="g-card-body" style="text-align:center">
          <div style="font-size:64px;font-weight:800;color:#D97706;line-height:1">{avg_rating}</div>
          <div style="color:#D97706;font-size:24px;margin:8px 0">{"<i class=&#34;fa-solid fa-star&#34;></i>"*int(avg_rating)}{"<i class=&#34;fa-regular fa-star&#34;></i>"*(5-int(avg_rating))}</div>
          <div style="font-size:14px;color:#475569">{rating_count} review{"s" if rating_count!=1 else ""}</div>
        </div>
      </div>
      <div class="g-card">
        <div class="g-card-hdr" style="background:#1E3A5F">Rating Breakdown</div>
...
def render_profile(guide, msg="", err=""):
    ...
    body = f"""
    <div style="margin-bottom:24px">
      <div style="font-size:22px;font-weight:800;color:#0F172A">My Profile</div>
      <div style="font-size:14px;color:#475569">Update your public guide profile</div>
    </div>
    {alert}
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px">
      <div class="g-card">
        <div class="g-card-hdr" style="background:#1E3A5F"><i class=&#34;fa-solid fa-user&#34;></i> Profile Information</div>
        <div class="g-card-body">
          <form method="post" action="/guide/profile" style="display:flex;flex-direction:column;gap:14px">
            ...
            <button class="g-btn" type="submit" style="background:#1E3A5F;color:#fff;padding:12px">Save Profile</button>
          </form>
        </div>
      </div>
      <div class="g-card">
        <div class="g-card-hdr" style="background:#DC2626"><i class=&#34;fa-solid fa-lock&#34;></i> Change Password</div>
        <div class="g-card-body">
          <form method="post" action="/guide/profile" style="display:flex;flex-direction:column;gap:14px">
