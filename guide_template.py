        ...
        <aside style="width:230px;min-height:100vh;background:linear-gradient(180deg,#003087,#0038A8,#001a5e);display:flex;flex-direction:column;padding:0;position:fixed;top:0;left:0;z-index:100">
          ...
          <div style="padding:16px 12px;border-bottom:1px solid rgba(255,255,255,.1)">
            <div style="display:flex;align-items:center;gap:12px">
              <div style="width:44px;height:44px;border-radius:50%;background:rgba(255,255,255,.2);border:2px solid rgba(255,255,255,.4);display:flex;align-items:center;justify-content:center;font-size:18px;font-weight:900;color:#fff">{initials}</div>
              <div>
          ...
          <div style="padding:12px 10px;border-top:1px solid rgba(255,255,255,.1)">
            <a href="/guide/logout" style="display:flex;align-items:center;gap:10px;padding:10px 14px;border-radius:8px;text-decoration:none;font-size:13px;color:#C4B5FD">&#128682; Log Out</a>
          </div>
        </aside>
